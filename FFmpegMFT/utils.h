...
inline LPCWSTR guid_dxva2_string(const GUID& guid)
{
	//H.264
    ...
    //H.265
	IF_EQUAL_RETURN(guid, DXVA2_ModeHEVC_VLD_Main);
    IF_EQUAL_RETURN(guid, DXVA2_ModeHEVC_VLD_Main10);

    return NULL;
}

//https://docs.microsoft.com/en-us/windows/desktop/medfound/media-type-debugging-code
inline LPCWSTR GetGUIDNameConst(const GUID& guid)
{
	...
	IF_EQUAL_RETURN(guid, MFVideoFormat_V264); //     FCC('V264')
    IF_EQUAL_RETURN(guid, MFVideoFormat_V265); //     FCC('V265')
